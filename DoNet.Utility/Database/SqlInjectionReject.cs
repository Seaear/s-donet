...
namespace DoNet.Utility.Database
{
    public static class SqlInjectionReject
    {
        ...
        ///     T-SQL关键字
        /// </summary>
        private static readonly string[] TsqlKeyWords =
        {
        ...
        ///     ODBC关键字
        /// </summary>
        private static readonly string[] OdbcKeyWords =
        {
        ...
        public static bool CheckMssqlParameter(string sqlParameter)
        {
            ...
            //首先检查是否包含特殊字符
            foreach (var checkString in SpecialWords)
            {
            ...
            var check = sqlParameter.Split(' ').ToArray();
            var result = true;
            foreach (var checkString in check)
            {
                ...
                if (OdbcKeyWords.Contains(checkString))
                {
                    result = false;
                    break;
                }
